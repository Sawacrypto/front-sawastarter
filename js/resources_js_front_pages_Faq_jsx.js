(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_front_pages_Faq_jsx"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "faqSendMessage": () => (/* binding */ faqSendMessage)
/* harmony export */ });
/* harmony import */ var _Api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Api */ "./resources/js/apis/Api.js");


var faqSendMessage = function faqSendMessage(form) {
  return (0,_Api__WEBPACK_IMPORTED_MODULE_0__["default"])().post('/faq/send-message', form);
};
...
/***/ "./resources/js/front/components/FaqForm.jsx":
/*!***************************************************!*\
  !*** ./resources/js/front/components/FaqForm.jsx ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FaqForm)
/* harmony export */ });
...
/* harmony import */ var _apis_Faq__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../apis/Faq */ "./resources/js/apis/Faq.js");
/* harmony import */ var _components_Notification__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/Notification */ "./resources/js/front/components/Notification.jsx");
...
function FaqForm() {
  ...
  var handleFaqForm = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return (0,_apis_Faq__WEBPACK_IMPORTED_MODULE_3__.faqSendMessage)(formData);
    ...
    return function handleFaqForm(_x) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("p", {
      className: "faq__name",
      children: ["Didn't find the answer to your question? ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("br", {}), " Ask it to us personally!"]
    }), success ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components_Notification__WEBPACK_IMPORTED_MODULE_4__["default"], {
      type: "success",
      title: "Success",
      message: "Mail successfully sent."
    }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("form", {
      action: "",
      className: "popup-form faq-form",
      onSubmit: function onSubmit(e) {
        return handleFaqForm(e);
      },
      children: [Object.keys(errors).map(function (key) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components_Notification__WEBPACK_IMPORTED_MODULE_4__["default"], {
          type: "error",
          title: key,
          message: errors[key]
        }, key);
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(react_google_recaptcha__WEBPACK_IMPORTED_MODULE_2__["default"], {
...
/***/ "./resources/js/front/pages/Faq.jsx":
/*!******************************************!*\
  !*** ./resources/js/front/pages/Faq.jsx ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_rootSlice__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../store/rootSlice */ "./resources/js/store/rootSlice.js");
/* harmony import */ var _utils_setSeoData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/setSeoData */ "./resources/js/utils/setSeoData.js");
/* harmony import */ var _components_FaqForm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/FaqForm */ "./resources/js/front/components/FaqForm.jsx");
...
function Faq() {
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]),
      _useState6 = _slicedToArray(_useState5, 2),
      filteredFaqs = _useState6[0],
      setFilteredFaqs = _useState6[1];

  var slug = 'faq';

  var getPostData = /*#__PURE__*/function () {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0,_apis_Post__WEBPACK_IMPORTED_MODULE_3__.getPage)(slug);
  ...
  var filterFaq = function filterFaq(e) {
    var searchValues = e.target.value.trim().split(' ');
    var filteredFaqs = faqs;
    searchValues.map(function (searchValue) {
      var searchText = searchValue.trim();
    ...
    filteredFaqs = filteredFaqs.map(function (faq) {
      var question = faq.question;
      var answer = faq.answer;
      searchValues.map(function (searchValue) {
        var searchText = searchValue.trim().toLowerCase();

        if (searchText.length > 1) {
          var regex = new RegExp(searchText, 'gi');
          question = question.replaceAll(regex, "<i>".concat(searchText, "</i>"));
          answer = answer.replaceAll(regex, "<i>".concat(searchText, "</i>"));
        }
      });
      return {
        question: question,
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    if (post) {
      (0,_utils_setSeoData__WEBPACK_IMPORTED_MODULE_5__["default"])(post);

      var _faqs = JSON.parse(post.content);
      ...
      dispatch((0,_store_rootSlice__WEBPACK_IMPORTED_MODULE_4__.setBreadcrumbItems)(breadcrumbItems));
    }
  }, [post]);
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("div", {
      ...
      children: [post && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("h1", {
          ...
          children: filteredFaqs.map(function (faq, index) {
            ...
            }, "".concat(index, "_").concat(faq.question, "_").concat(faq.answer));
          })
        })]
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_FaqForm__WEBPACK_IMPORTED_MODULE_6__["default"], {})]
    })
  });
}
